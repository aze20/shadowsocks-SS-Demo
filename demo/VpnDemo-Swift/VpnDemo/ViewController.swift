...
class ViewController: UIViewController {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(onVPNStatusChanged),
                                               name: NSNotification.Name(rawValue: kProxyServiceVPNStatusNotification), object: nil)
    }
