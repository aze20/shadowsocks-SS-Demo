...
extension VpnManager{
    ...
    fileprivate func setRulerConfig(_ manager:NETunnelProviderManager){
        ...
        conf["ss_address"] = "88.88.88.38" as AnyObject?
        conf["ss_port"] = 8888888 as AnyObject?
        conf["ss_method"] = "AES256CFB" as AnyObject? // 大写 no'-'
        conf["ss_password"] = "xxxxx" as AnyObject?
